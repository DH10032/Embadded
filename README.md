...
<details>
  ...
  3/24일부터 구매할 파워보드/카메라 조사 및 구매, 각 수치 측정 후 몸체설계 담당에게 정보 전달
  3/25일부터 -> 모터 드라이버 도착예정 -> 바로 회로연결(모터작동 시험)
  3/26일부터 -> 카메라 위치를 고려한 수치로 몸체 설계시작
  3/27 - 카메라 및 파워보드 연결 및 시험
  3/30~3/31 몸체 제작 밑 결합 -> 이론상 여기까지 기본형 제작
  4/1일까지</br>
